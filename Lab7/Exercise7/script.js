...
button.addEventListener("click", function () {
  ...
  output.innerHTML = `
                ...
                <strong>Child Elements:</strong> <br>${Array.from(children)
                  .map((child) => child.outerHTML)
                  .join("<br>")}<br><br>
                <strong>Next Sibling Element:</strong> <br>${
                  nextSibling ? nextSibling.outerHTML : "None"
                }<br><br>
                <strong>Previous Sibling Element:</strong> <br>${
                  previousSibling ? previousSibling.outerHTML : "None"
                }
            `;
});
